                ...
                <?php
                   if($_SERVER['REQUEST_METHOD'] == 'POST'){
                      ...
                      if($title == "" || $cat == "" || $body == "" || $tags == "" || $author == "" || $file_name == ""){                       
                        ...
                        $query = "INSERT INTO tbl_posts(cat,title,body,image,author,tags,userid) VALUES(

                           '$cat', '$title', '$body', '$uploaded_image', '$author','$tags','$userid')";
                 ...
                 <form action="addpost.php" method="post" enctype="multipart/form-data">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="tags" placeholder="Enter Post Tags..."/>
                            </td>
                        </tr>
